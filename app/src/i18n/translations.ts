...
export const translations: Record<Language, Translations> = {
  it: {
    ...
    home: {
      ...
      pillarsBoldIntro: 'Lab Pro crea pane, focacce e prodotti da forno artigianali. Qualità artigianale italiana tra tradizione e innovazione.',
      pillarsIntro: 'Lab Pro è un\'azienda artigianale italiana specializzata nella produzione di pane, focacce e prodotti da forno artigianali, dove tradizione e innovazione si incontrano ogni giorno. Realizziamo prodotti da forno di eccellenza basati su quattro pilastri fondamentali che garantiscono qualità, autenticità e rispetto della materia prima.',
    },
    about: {
      title: 'Chi Siamo',
    ...
    bread: {
      title: 'Lab Pro – Pane naturale',
      pillarsIntro: 'Il nostro pane è una sfida tecnica ed estetica: la farina di Tipo 2 macinata a pietra ha una densità di fibre e sali minerali che la "00" non avrà mai, e quel 30% di Lievito Madre spinge tantissimo sugli aromi lattici e sulla conservazione.',
      pillar1Title: 'Farina di Tipo 2 Macinata a Pietra',
      pillar1Subtitle: '"L\'Anima del Grano"',
      pillar1Text: 'A differenza delle farine industriali "morte", la nostra Tipo 2 conserva il germe di grano e la parte esterna del chicco. La macinazione a pietra a bassa velocità non surriscalda il chicco, preservando gli oli essenziali e i sali minerali. È un pane "scuro" nell\'anima, ricco di fibre che nutrono il microbiota e abbassano l\'indice glicemico.',
      pillar1List: [],
      pillar1Conclusion: '',
      pillar2Title: '30% di Lievito Madre',
      pillar2Subtitle: '"Fermentazione Viva"',
      pillar2Text: 'Usiamo una percentuale altissima di lievito madre vivo (30%) per garantire una predigestione completa dei cereali. Questo non è pane "gonfiato" con gas. È pane trasformato dagli enzimi. Il lievito madre dona un profilo aromatico lattico (più dolce e meno aggressivo dell\'acetico) e una conservazione naturale che dura oltre una settimana.',
      pillar2List: [],
      pillar2Conclusion: '',
      pillar3Title: 'Idratazione al 75%',
      pillar3Subtitle: '"Mollica Cremosa, Crosta Caramellata"',
      pillar3Text: 'Gestire al 75% di acqua su una farina di tipo 2 richiede una tecnica magistrale nella gestione della maglia glutinica. L\'alta idratazione è il segreto della nostra "mollica custardy" (cremosa). L\'acqua intrappolata esplode in forno creando una struttura leggera ma umida, che scioglie i profumi del grano ad ogni morso.',
      pillar3List: [],
      pillar3Conclusion: '',
      pillar4Title: 'Sale Integrale',
      pillar4Subtitle: '"Il Sapore del Mare"',
      pillar4Text: 'Non usiamo comune sale raffinato (cloruro di sodio puro), ma sale integrale ricco di oligoelementi. Il sale integrale esalta la sapidità naturale del grano senza aggredire le papille gustative. È una scelta di salute che completa il profilo minerale del pane.',
      evolvesTitle: 'Un pane che evolve',
      evolvesText: 'Questo non è un pane statico. È un pane che respira, matura e cambia nel tempo. Dopo il taglio, lasciarlo riposare qualche minuto permette alla mollica di stabilizzarsi e agli aromi di aprirsi. Il giorno successivo, il profilo gustativo risulta ancora più armonico. Una leggera tostatura esalta ulteriormente il lavoro della farina di Tipo 2, sviluppando note di nocciola e caramello che le farine raffinate non possono offrire.',
      judgedTitle: 'Quando un pane è diverso, viene giudicato',
      judgedIntro: '(E perché queste "critiche" raccontano la sua eccellenza)\n\nUn pane costruito su materia viva, alta idratazione e fermentazione profonda non può essere neutro. Chi è abituato a pane standardizzato incontra sensazioni nuove, e spesso le traduce in obiezioni. In realtà, ogni critica è la conseguenza diretta delle scelte tecniche fatte.',
      faq1Q: '"Il pane è troppo pesante"',
      faq1A: 'La farina Tipo 2 macinata a pietra contiene la parte più nobile del chicco (germe e crusca). Queste fibre pesano fisicamente di più dell\'amido puro. Non è pesante, è denso di nutrienti. Il pane bianco è fatto di "aria" e amidi raffinati che gonfiano ma non nutrono. Il nostro pane Tipo 2 è un cibo completo: pesa di più perché dentro c\'è tutta la forza del grano italiano e la crusca macinata a pietra. Una sola fetta vi dà l\'energia e la sazietà di tre fette di pane comune.',
      faq2Q: '"La mollica è troppo mollicosa / umida"',
      faq2A: 'Con la farina Tipo 2 e il 30% di lievito madre, l\'idratazione è altissima. L\'umidità che il cliente sente è l\'acqua "intrappolata" nella maglia glutinica che mantiene il pane vivo. Non è molliccio, è idratato. Quell\'umidità che sente è la garanzia che il pane non diventerà segatura dopo poche ore. Grazie al 30% di lievito madre liquido, abbiamo una mollica "cremosa" che scioglie gli aromi del grano. È un pane "vivo" che continua a evolversi: provatelo domani e sarà ancora più buono.',
      faq3Q: '"È troppo saporito / sento un gusto diverso"',
      faq3A: 'La macinazione a pietra preserva gli oli essenziali del chicco, e il LiCoLi sviluppa aromi che ricordano lo yogurt, il burro e il grano tostato. Questo è il vero sapore del grano. Usiamo il 30% di lievito madre proprio per evitare il gusto piatto del lievito di birra. È un pane da degustazione: provatelo con un filo d\'olio o un formaggio, e capirete che il pane non è solo un supporto, ma un ingrediente fondamentale.',
      faq4Q: 'Consigli pratici',
      faq4A: 'La Regola dei 10 Minuti: il pane a lievito madre Tipo 2 va affettato e lasciato respirare qualche minuto. Essendo molto idratato, l\'ossigeno aiuta a stabilizzare la mollica e a sprigionare i profumi. Il Test del Tostapane: Se un cliente lo trova "troppo mollicoso", consiglia una leggera tostatura. Con la Tipo 2, la reazione di Maillard (la doratura) è incredibile: il pane sprigionerà aromi di nocciola e caramello che il pane bianco si sogna.',
    ...
    contact: {
      ...
      faqItems: [
        ...
        },
        {
          ...
          answer: 'I nostri prodotti sono disponibili presso il laboratorio Lab Pro di Torino in Via Jonio n. 5 (dal lunedì al venerdì, dalle 8 alle 18) e attraverso distributori selezionati. Per informazioni commerciali contattaci a andrea@lab-pro.it.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Siamo sempre alla ricerca di persone motivate sia nell\'area produzione che commerciale. Visita la sezione "Lavora con Noi" o inviaci la tua candidatura a andrea@lab-pro.it.',
        },
      ],
    },
    footer: {
  ...
  en: {
    ...
    home: {
      ...
      pillarsBoldIntro: 'Lab Pro creates bread, focaccia and artisan bakery products. Italian artisan quality between tradition and innovation.',
      pillarsIntro: 'Lab Pro is an Italian artisan company specialising in the production of bread, focaccia and artisan bakery products, where tradition and innovation meet every day. We create bakery products of excellence based on four fundamental pillars that guarantee quality, authenticity and respect for raw materials.',
    },
    about: {
      title: 'About Us',
    ...
    bread: {
      title: 'Lab Pro – Natural Bread',
      pillarsIntro: 'Our bread is a technical and aesthetic challenge: Type 2 stone-ground flour has a density of fibre and minerals that "00" flour will never have, and that 30% Sourdough Starter pushes tremendously hard on lactic aromas and preservation.',
      pillar1Title: 'Type 2 Stone-Ground Flour',
      pillar1Subtitle: '"The Soul of the Grain"',
      pillar1Text: 'Unlike "dead" industrial flours, our Type 2 flour preserves the wheat germ and the outer part of the grain. Low-speed stone grinding does not overheat the grain, preserving essential oils and mineral salts. It is a bread "dark" in its soul, rich in fibre that nourishes the microbiota and lowers the glycaemic index.',
      pillar1List: [],
      pillar1Conclusion: '',
      pillar2Title: '30% Sourdough Starter',
      pillar2Subtitle: '"Living Fermentation"',
      pillar2Text: 'We use an extremely high percentage of live sourdough starter (30%) to ensure complete pre-digestion of cereals. This is not bread "puffed up" with gas. It is bread transformed by enzymes. The sourdough starter gives a lactic aromatic profile (sweeter and less aggressive than acetic) and natural preservation that lasts beyond a week.',
      pillar2List: [],
      pillar2Conclusion: '',
      pillar3Title: '75% Hydration',
      pillar3Subtitle: '"Creamy Crumb, Caramelised Crust"',
      pillar3Text: 'Managing 75% water on Type 2 flour requires masterful technique in managing the gluten network. High hydration is the secret of our "custardy crumb" (creamy). The trapped water explodes in the oven creating a light but moist structure, which releases the perfumes of the grain with every bite.',
      pillar3List: [],
      pillar3Conclusion: '',
      pillar4Title: 'Whole Salt',
      pillar4Subtitle: '"The Taste of the Sea"',
      pillar4Text: 'We do not use common refined salt (pure sodium chloride), but whole salt rich in trace elements. Whole salt enhances the natural sapidity of the grain without attacking the taste buds. It is a health choice that completes the mineral profile of the bread.',
      evolvesTitle: 'A bread that evolves',
      evolvesText: 'This is not a static bread. It is a bread that breathes, matures and changes over time. After cutting, letting it rest for a few minutes allows the crumb to stabilise and the aromas to open up. The following day, the flavour profile is even more harmonious. A light toasting further enhances the work of the Type 2 flour, developing notes of hazelnut and caramel that refined flours cannot offer.',
      judgedTitle: 'When a bread is different, it gets judged',
      judgedIntro: '(And why these "criticisms" tell the story of its excellence)\n\nA bread built on living matter, high hydration and deep fermentation cannot be neutral. Those accustomed to standardised bread encounter new sensations, and often translate them into objections. In reality, every criticism is a direct consequence of the technical choices made.',
      faq1Q: '"The bread is too heavy"',
      faq1A: 'Type 2 stone-ground flour contains the noblest part of the grain (germ and bran). These fibres weigh physically more than pure starch. It\'s not heavy, it\'s dense with nutrients. White bread is made of "air" and refined starches that puff up but don\'t nourish. Our Type 2 bread is a complete food: it weighs more because it contains all the strength of Italian grain and stone-ground bran. A single slice gives you the energy and satiety of three slices of common bread.',
      faq2Q: '"The crumb is too soft / moist"',
      faq2A: 'With Type 2 flour and 30% sourdough starter, hydration is extremely high. The moisture the customer feels is the water "trapped" in the gluten network that keeps the bread alive. It\'s not soggy, it\'s hydrated. That moisture you feel is the guarantee that the bread won\'t turn into sawdust after a few hours. Thanks to 30% liquid sourdough starter, we have a "creamy" crumb that releases the aromas of the grain. It\'s a "living" bread that continues to evolve: try it tomorrow and it will be even better.',
      faq3Q: '"It\'s too flavourful / I taste something different"',
      faq3A: 'Stone grinding preserves the essential oils of the grain, and the LiCoLi develops aromas reminiscent of yoghurt, butter and toasted grain. This is the true flavour of grain. We use 30% sourdough starter precisely to avoid the flat taste of baker\'s yeast. It\'s a tasting bread: try it with a drizzle of oil or cheese, and you\'ll understand that bread is not just a support, but a fundamental ingredient.',
      faq4Q: 'Practical advice',
      faq4A: 'The 10-Minute Rule: Type 2 sourdough bread should be sliced and left to breathe for a few minutes. Being very hydrated, oxygen helps stabilise the crumb and release the aromas. The Toaster Test: If a customer finds it "too moist", suggest a light toasting. With Type 2, the Maillard reaction (browning) is incredible: the bread will release aromas of hazelnut and caramel that white bread can only dream of.',
    ...
    contact: {
      ...
      faqItems: [
        ...
        },
        {
          ...
          answer: 'Our products are available at the Lab Pro workshop in Turin at Via Jonio 5 (Monday to Friday, 8am to 6pm) and through selected distributors. For commercial information, contact us at andrea@lab-pro.it.',
        },
        {
        ...
        },
        {
          ...
          answer: 'We are always looking for motivated people in both production and commercial areas. Visit the "Work with Us" section or send your application to andrea@lab-pro.it.',
        },
      ],
    },
    footer: {
